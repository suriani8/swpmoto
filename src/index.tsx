...
const ReactApp = () => {
  ...
  return (
    <StrictMode>
      <SEO
        title="MotoranSwap - Swap and earn tokens at the best rates"
        description="MotoranSwap is DeFi‚Dynamic Market Maker; a decentralized exchange protocol that provides frictionless crypto liquidity with extremely high flexibility and capital efficiency. MotoranSwap is major protocol liquidity hub."
      />
      <FixedGlobalStyle />
